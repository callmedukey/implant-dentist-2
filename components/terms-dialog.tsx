...
제1조 목적
이 약관은 속초 조은이플란트치과의원(이하 '본원')에서 제공하는 서비스 이용조건 및 절차에 관한 사항과 기타 필요한 사항을 본원과 이용자의 권리, 의미 및 책임사항 등을 규정함을 목적으로 합니다.
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] p-0">
        <DialogHeader className="px-6 py-4 border-b">
          <DialogTitle className="text-2xl font-bold text-dark-primary">
            이용약관
          </DialogTitle>
          <button
        ...
        <ScrollArea className="h-[calc(80vh-80px)] px-6 py-4">
          <div className="prose prose-sm max-w-none">
            <pre className="whitespace-pre-wrap font-sans text-sm leading-relaxed text-dark-primary">
              {termsContent}
            </pre>
          </div>
        </ScrollArea>
